 ...
 */
package mg.rakotobeherinirinaangelo.tpbanquerakotobeherinirinaangelo.entity;
...
public class OperationBancaire implements Serializable {
    ...
    public String toString() {
        return "mg.rakotobeherinirinaangelo.tpbanquerakotobeherinirinaangelo.entity.OperationBancaire[ id=" + id + " ]";
    }
